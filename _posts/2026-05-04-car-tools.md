...
I just had this laying around and figured it might be useful. It has not been. Generally speaking, tools should follow the {% include external_link.html href="https://en.wikipedia.org/wiki/Unix_philosophy" text="Unix philosophy" %}. In my experience tools that do multiple things are compromised at everything and excel at nothing.
...
### magnetic level
Possibly the GOAT. So useful. A level takes amateur effort and turns it into a professional result. Picture hanging. This one has a (very weak) magnet which is surprisingly useful. You do _not_ have the ability to eyeball levelness, do not try.

### Phillips/flathead screwdriver
Absolutely essential. In an ideal world we'd use {% include external_link.html href="https://en.wikipedia.org/wiki/Robertson_screw#Licensing" text="Robertson bits" %} instead of Phillips but oh well.
...
Most importantly, I keep a cheap set of ratchet straps. It is impossible for me to state just how much better the _worst_ set of ratchet straps is compared to a rope. Ratchet straps have a bit of a learning curve though. You put the end of it through the ratchet and only ratchet it about 5-10 times to get it tight. Do not try and ratchet the entire strap or it will not work! A set of 4 like these at Harbor Freight is $10. I like that they're cheap enough I can give them away when I need to. I feel a lot better about donating a $2.50 strap to an underprepared fella than risking the possibility of losing a load on the road and someone getting hurt.

{% include figure.html
	src="assets/images/posts/car-tools/IMG_4998.jpeg"
	alt="Leather gloves, a sunglasses case, and a 3x5 index vehicle maintenance log."
...
| Item | Price | Store |
|------|-------|-------|
| {% include external_link.html href="https://www.harborfreight.com/12-in-tool-bag-with-21-pockets-61467.html" text="12 in. Tool Bag W/ 21 Pockets" %} | $4.99 | HF |
| {% include external_link.html href="https://www.harborfreight.com/color-snap-blade-utility-knife-60828.html" text="Breakaway Box Cutters (x2)" %} | $0.99 | HF |
| {% include external_link.html href="https://www.harborfreight.com/7-inch-wire-stripper-with-cutter-98410.html" text="Wire Stripper" %} | $6.99 | HF |
| {% include external_link.html href="https://www.harborfreight.com/micro-flush-cutter-90708.html" text="Micro Flush Cutters" %} | $2.99 | HF |
| {% include external_link.html href="https://www.harborfreight.com/nitrile-dipped-work-gloves-large-66374.html" text="Nitrile Dipped Work Gloves" %} | $1.99 | HF |
| {% include external_link.html href="https://www.harborfreight.com/10-inch-steel-adjustable-wrench-65801.html" text="10 in. Adjustable Steel Wrench" %} | $7.99 | HF |
| {% include external_link.html href="https://www.harborfreight.com/6-in-diagonal-cutters-63816.html" text="6 in. Diagonal Cutters" %} | $3.99 | HF |
| {% include external_link.html href="https://www.harborfreight.com/17-piece-sae-metric-hex-key-set-94650.html" text="SAE/Metric Hex Key" %} | $6.99 | HF |
| {% include external_link.html href="https://www.harborfreight.com/12-ft-x-12-in-quikfind-tape-measure-with-abs-casing-62464.html" text="12 ft. Tape Measure" %} | $2.99 | HF |
| {% include external_link.html href="https://www.harborfreight.com/6-in-1-screwdrivernut-driver-61988.html" text="6-in-1 Screwdriver" %} | $2.99 | HF |
| {% include external_link.html href="https://www.harborfreight.com/6-inch-level-with-magnetic-strip-37588.html" text="6 in. Magnet Level" %} | $2.49 | HF |
| {% include external_link.html href="https://www.harborfreight.com/1-4-quarter-inch-x-10-ft-diamond-braid-rope-96186.html" text="10 ft. Rope" %} | $1.49 | HF |
| {% include external_link.html href="https://www.harborfreight.com/10-in-groove-joint-pliers-69379.html" text="10 in. Groove Joint Pliers" %} | $8.99 | HF |
| {% include external_link.html href="https://www.harborfreight.com/60-ft-x-34-in-industrial-grade-electrical-tape-63239.html" text="Electrical Tape" %} | $1.99 | HF |
| {% include external_link.html href="https://www.harborfreight.com/8-in-needle-nose-pliers-63824.html" text="8 in. Needle Nose Pliers" %} | $3.99 | HF |
| {% include external_link.html href="https://www.harborfreight.com/14-in-drive-sae-and-metric-high-visibility-socket-set-21-piece-62303.html" text="3/8 in. 21 pc. Socket Set" %} | $24.99 | HF |
