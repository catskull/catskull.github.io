...
The issue for me is the project management software we ~~choose~~ are force to use. I won't name names, but it labels itself as "Software to replace all software", which not only violates the [Unix philosphy of "do one thing and do it well"](https://en.wikipedia.org/wiki/Unix_philosophy#Do_One_Thing_and_Do_It_Well) but is also an affront to my very morality. I can promise you that this "everything software" truly does _nothing_ well. Not one thing. It is extremely slow. I actually just timed it and it takes _15 full seconds_ to load our current sprint. It is extremely limiting to my workflow. I hate it.
